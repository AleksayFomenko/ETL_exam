...
Описание исходных данных, загруженных из предыдущего пункта: </p>
Этот набор данных содержит список 100 самых популярных песен (с текстами) за каждый год с 1959 по 2023 год в Соединенных Штатах.

Распределение по медиа (тип: Круговая)
![Дашборд DataLens](screens/task4_1.png)

Топ авторов по числу песен (тип: Bar)
![Дашборд DataLens](screens/task4_2.png)

Соединение реализовано через yandex query
